    ...
    <div className={styles.container}>
      <div className={styles.dashboardContainer}>
        ...
        <nav className={`${styles.sidebar} ${sidebarOpen ? styles.sidebarOpen : ""}`}>
          ...
          <div className={`${styles.sidebarLink} ${tab === "dashboard" ? styles.sidebarLinkActive : ""}`} onClick={() => { setTab("dashboard"); setSidebarOpen(!sidebarOpen); }}>
                <Home size={20} />
                <span>Dashboard</span>
          </div>

          <div className={`${styles.sidebarLink} ${tab === "news" ? styles.sidebarLinkActive : ""}`} onClick={() => { setTab("news"); setSidebarOpen(!sidebarOpen); }}>
                <Newspaper size={20} />
                <span>News</span>
          </div>

          <div className={`${styles.sidebarLink} ${tab === "assignments" ? styles.sidebarLinkActive : ""}`} onClick={() => { setTab("assignments"); setSidebarOpen(!sidebarOpen); }}>
                <BookA size={20} />
        ...
        <div className={`${styles.hamburgerMenu} ${sidebarOpen ? styles.active : ""}`} onClick={() => setSidebarOpen(!sidebarOpen)}>
